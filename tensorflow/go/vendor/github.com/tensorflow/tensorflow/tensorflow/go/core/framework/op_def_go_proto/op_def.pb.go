...
type OpDef_ArgDef struct {
	...
	ExperimentalFullType *types_go_proto.FullTypeDef `protobuf:"bytes,17,opt,name=experimental_full_type,json=experimentalFullType,proto3" json:"experimental_full_type,omitempty"`
}
...
func (x *OpDef_ArgDef) GetExperimentalFullType() *types_go_proto.FullTypeDef {
	if x != nil {
...
var file_tensorflow_core_framework_op_def_proto_goTypes = []interface{}{
	...
	(*types_go_proto.FullTypeDef)(nil),                                 // 7: tensorflow.FullTypeDef
