...
type RunGraphResponse struct {
	...
	StatusCode         for_core_protos_go_proto.Code `protobuf:"varint,5,opt,name=status_code,json=statusCode,proto3,enum=tensorflow.error.Code" json:"status_code,omitempty"`
...
func (x *RunGraphResponse) GetStatusCode() for_core_protos_go_proto.Code {
	if x != nil {
		return x.StatusCode
	}
	return for_core_protos_go_proto.Code(0)
}
...
var file_tensorflow_core_protobuf_worker_proto_goTypes = []interface{}{
	...
	(for_core_protos_go_proto.Code)(0),                  // 45: tensorflow.error.Code
