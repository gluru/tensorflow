...
type RunStepResponse struct {
	...
	StatusCode         for_core_protos_go_proto.Code `protobuf:"varint,3,opt,name=status_code,json=statusCode,proto3,enum=tensorflow.error.Code" json:"status_code,omitempty"`
...
func (x *RunStepResponse) GetStatusCode() for_core_protos_go_proto.Code {
	if x != nil {
		return x.StatusCode
	}
...
var file_tensorflow_core_protobuf_master_proto_goTypes = []interface{}{
	...
	(for_core_protos_go_proto.Code)(0),                  // 25: tensorflow.error.Code
